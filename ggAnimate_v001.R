...
gganimate <- function(j){
  ...
  ggsave(paste0("ggAnimatePlot_", sprintf("%03d", j), ".png"), gg,
         height = 6, width = 6, unit = "cm", scale = 2)
}               
...
# Some additional functionality with the saveHTML() function, but as far as I can tell is pretty
# local and can't be embedded into outher media.
